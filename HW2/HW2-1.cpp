...
void add(char *a, char *b){
    ...
    while(posA >= 0){
        ...
        if(temp >= 10){
            carry = 1; //进位1
            result[posA] = temp - 10 + '0'; // + '0' for back to number in char
        }else {
            carry = 0;
            result[posA] = temp + '0';
        }
...
void div(char *a, char *b){
    ...
    while(pos != len_a){
        ...
        if((tempR[0] == '0' && quotient[0] == '\0') == 0)  
            //if the found quotient is 0 and quotient is null then skip this 
...
int main(){
    ...
    while(1){
        ...
        printf("a / b = ");
        if(b[0] == '0') printf("输入错误，不能除以0！！！\n");
        else if(a[0] == '0') printf("0\n");
        else div(a,b);

        printf("a % b = ");
        if(b[0] == '0') printf("输入错误，不能除以0！！！\n");
        else if(a[0] == '0'|| remainder[0] == '0') printf("0\n");
        else printf("%s\n",remainder);
